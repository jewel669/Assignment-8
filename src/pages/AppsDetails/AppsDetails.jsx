...
const AppsDetails = ({fainalData}) => {
    console.log(fainalData);

    const {image,title,downloads,ratingAvg,id} = fainalData;

    return (
        <div>
            <Link to={`/dataDetails/${id}`}>
              <div className="card bg-base-100 w-96 mx-auto shadow-sm hover">
                    <figure>
